...
Pass any url-like string to Earl:
    ...
    my_earl_instance = Earl.new('https://github.com/teejayvanslyke/earl')
    #
    # or using the []= convenience method:
    my_earl_instance = Earl['https://github.com/teejayvanslyke/earl']


=== How do I inspect details of the page?

    earl = Earl['https://github.com/teejayvanslyke/earl']
    earl.title
    =>  "teejayvanslyke/earl · GitHub"
    earl.description
